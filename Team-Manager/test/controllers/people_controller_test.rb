...
class PeopleControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create person" do
    assert_difference('Person.count') do
      post people_url, params: { person: { addr_city: @person.addr_city, addr_route: @person.addr_route, addr_state: @person.addr_state, addr_zip: @person.addr_zip, bio: @person.bio, birth_date: @person.birth_date, first_name: @person.first_name, gender: @person.gender, height_in_inches: @person.height_in_inches, last_name: @person.last_name, pass_hash: @person.pass_hash, pass_salt: @person.pass_salt, username: @person.username, weight_in_pounds: @person.weight_in_pounds } }
    end
