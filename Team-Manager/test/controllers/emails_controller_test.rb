...
class EmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email" do
    assert_difference('Email.count') do
      post emails_url, params: { email: { email: @email.email, person_id: @email.person_id } }
    end
  ...
  test "should update email" do
    patch email_url(@email), params: { email: { email: @email.email, person_id: @email.person_id } }
