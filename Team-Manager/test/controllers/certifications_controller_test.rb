...
class CertificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post certifications_url, params: { certification: { certification_name: @certification.certification_name, expiration_date: @certification.expiration_date, note: @certification.note, person_id_id: @certification.person_id_id } }
    end
  ...
  test "should update certification" do
    patch certification_url(@certification), params: { certification: { certification_name: @certification.certification_name, expiration_date: @certification.expiration_date, note: @certification.note, person_id_id: @certification.person_id_id } }
